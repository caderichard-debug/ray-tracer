...
# Features: Scene graph, Lights, Phong shading, Shadows, Reflections
.PHONY: phase2
phase2:
	@echo "Building Phase 2: Basic Rendering"
	@echo "Features: Scene, Lights, Phong shading, Shadows, Reflections"
	$(CXX) $(CXXFLAGS) $(OPTFLAGS) $(INCLUDES) \
		$(ALL_SRCS) \
		-o $(BUILD_DIR)/raytracer_phase2
...
# Benchmark all implemented phases
.PHONY: benchmark
benchmark:
...
help:
	...
	@echo "  make phase3      - Build Phase 3 (SIMD vectorization) [TODO]"
	@echo "  make phase4      - Build Phase 4 (advanced features) [TODO]"
	@echo "  make phase5      - Build Phase 5 (multi-threading) [TODO]"
	@echo "  make phase6      - Build Phase 6 (polish) [TODO]"
	@echo "  make all         - Build all implemented phases"
	@echo ""
	@echo "Running:"
	@echo "  make run         - Build and run current phase"
