...
inline void setup_gpu_demo_scene(Scene& scene) {
    ...
    polished_mat->name = "Polished_R0.15";
    ...
    semimate_mat->name = "SemiMtte_R0.55";
    ...
    matte_metal_mat->name = "Matte_R0.75";
    ...
    red_plastic_mat->name = "RedPlastic_M0.0";
